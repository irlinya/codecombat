...
#    creativity_rigor_title: "Where Creativity Meets Rigor"
    creativity_rigor_subtitle1: "Kodlamayı eğlenceli hale getirin ve gerçek dünya becerilerini öğretin"
    creativity_rigor_blurb1: "Öğrenciler deneme-yanılma, eleştirel düşünme ve yaratıcılığı teşvik eden oyunlar oynarken gerçek Python ve JavaScript ile kodlama yaparlar. Öğrenciler daha sonra proje tabanlı kurslarda kendi oyunlarını ve web sitelerini geliştirerek öğrendikleri kodlama becerilerini uygularlar."
    creativity_rigor_subtitle2: "Öğrencilere kendi seviyelerinde ulaşın"
#    creativity_rigor_blurb2: "Every CodeCombat level is scaffolded based on millions of data points and optimized to adapt to each learner. Practice levels and hints help students when they get stuck, and challenge levels assess students' learning throughout the game."
    creativity_rigor_subtitle3: "Deneyimden bağımsız olarak tüm öğretmenler için tasarlandı"
    creativity_rigor_blurb3: "CodeCombat'ın kendi hızında ilerleyen, standartlarla uyumlu müfredatı, bilgisayar bilimi öğretimini herkes için mümkün kılıyor. CodeCombat, öğretmenleri sınıfta kendilerini güvende ve başarılı hissetmeleri için eğitim, öğretim kaynakları ve özel destek ile donatır."
    featured_partners_title1: "Featured In"
    featured_partners_title2: "Ödüller & Ortaklar"
#    featured_partners_blurb1: "Clever Partner"
    featured_partners_blurb2: "Öğrenciler için En İyi Yaratıcılık Aracı"
    featured_partners_blurb3: "Öğrenim için En İyi Seçim"
    featured_partners_blurb4: "Code.org Resmi Ortağı"
    featured_partners_blurb5: "CSforAll Resmi Üyesi"
#    featured_partners_blurb6: "Hour of Code Activity Partner"
    for_leaders_title: "Okul Liderleri İçin"
    for_leaders_blurb: "Kapsamlı, Standartlarla Uyumlu Bilgisayar Bilimleri Programı"
    for_leaders_subtitle1: "Kolay Uygulama"
#    for_leaders_subblurb1: "A web-based program that requires no IT support. Get started in under 5 minutes using Google or Clever Single Sign-On (SSO)."
    for_leaders_subtitle2: "Eksiksiz Kodlama Müfredatı"
    for_leaders_subblurb2: "Herhangi bir öğretmenin bilgisayar bilimi öğretmesini sağlamak için öğretim kaynakları ve profesyonel gelişim ile standartlarla uyumlu bir müfredat."
...
#    for_leaders_subblurb4: "Students build grit and develop a growth mindset through coding challenges that prepare them for the 500K+ open computing jobs."
    ...
    for_teachers_blurb: "Öğrenci Potansiyelini Ortaya Çıkaracak Araçlar"
    for_teachers_subtitle1: "Proje Tabanlı Öğrenme"
    for_teachers_subblurb1: "Öğrencilerin kendi oyunlarını ve web sayfalarını geliştirdikleri proje tabanlı derslerde yaratıcılığı, problem çözmeyi ve özgüveni geliştirmelerini destekleyin."
    for_teachers_subtitle2: "Öğretmen Kontrol Paneli"
    for_teachers_subblurb2: "Öğrenci ilerlemesine dair verileri inceleyebilir, müfredat kaynaklarını keşfedebilir ve öğrenci öğrenimini güçlendirmek adına gerçek zamanlı destek alabilirsiniz."
    for_teachers_subtitle3: "Yapılandırılabilir Değerlendirmeler"
    for_teachers_subblurb3: "Eğitimi kişiselleştirin ve öğrencilerin temel kavramları anladığından emin olmak için biçimlendirici ve özetleyici değerlendirmeleri kullanın."
...
#    game_based_blurb: "CodeCombat is a game-based computer science program where students type real code and see their characters react in real time."
    ...
    global_title: "Global Öğrenciler ve Eğitimciler Topluluğumuza Katılın"
    global_subtitle1: "Öğreniciler"
    global_subtitle2: "Kod Satırları"
...
#    quotes_quote5_author: "Latthaphon Pohpon, Parent"
    ...
    slogan_power_of_play: "Oynamanın Gücüyle Kodlamayı Öğrenin"
    teach_cs1_free: "CS1'i Ücretsiz Öğretin"
